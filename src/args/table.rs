...
const PE: &str = "not implemented yet (roadmap M7: PE/COFF)";
...
pub static GNU_OPTIONS: &[OptionDef] = &[
    ...
    // ---- PE/COFF (MinGW) ----
    uns("out-implib", V, PE),
    uns("add-stdcall-alias", F, PE),
    uns("base-file", V, PE),
    uns("dll", F, PE),
    uns("enable-stdcall-fixup", F, PE),
    uns("disable-stdcall-fixup", F, PE),
    uns("export-all-symbols", F, PE),
    uns("exclude-symbols", V, PE),
    uns("exclude-all-symbols", F, PE),
    uns("exclude-modules-for-implib", V, PE),
    uns("file-alignment", V, PE),
    uns("heap", V, PE),
    uns("kill-at", F, PE),
    uns("large-address-aware", F, PE),
    uns("disable-large-address-aware", F, PE),
    uns("major-image-version", V, PE),
    uns("minor-image-version", V, PE),
    uns("major-os-version", V, PE),
    uns("minor-os-version", V, PE),
    uns("major-subsystem-version", V, PE),
    uns("minor-subsystem-version", V, PE),
    uns("output-def", V, PE),
    uns("dll-search-prefix", V, PE),
    uns("enable-auto-image-base", OV, PE),
    uns("disable-auto-image-base", F, PE),
    uns("enable-auto-import", F, PE),
    uns("disable-auto-import", F, PE),
    uns("enable-runtime-pseudo-reloc", F, PE),
    uns("disable-runtime-pseudo-reloc", F, PE),
    uns("enable-runtime-pseudo-reloc-v1", F, PE),
    uns("enable-runtime-pseudo-reloc-v2", F, PE),
    uns("enable-extra-pe-debug", F, PE),
    uns("section-alignment", V, PE),
    uns("stack", V, PE),
    uns("subsystem", V, PE),
    uns("dynamicbase", F, PE),
    uns("disable-dynamicbase", F, PE),
    uns("no-dynamicbase", F, PE),
    uns("forceinteg", F, PE),
    uns("disable-forceinteg", F, PE),
    uns("nxcompat", F, PE),
    uns("disable-nxcompat", F, PE),
    uns("no-isolation", F, PE),
    uns("disable-no-isolation", F, PE),
    uns("no-seh", F, PE),
    uns("disable-no-seh", F, PE),
    uns("no-bind", F, PE),
    uns("disable-no-bind", F, PE),
    uns("wdmdriver", F, PE),
    uns("disable-wdmdriver", F, PE),
    uns("tsaware", F, PE),
    uns("disable-tsaware", F, PE),
    uns("insert-timestamp", F, PE),
    uns("no-insert-timestamp", F, PE),
    uns("high-entropy-va", F, PE),
    uns("disable-high-entropy-va", F, PE),
    uns("enable-long-section-names", F, PE),
    uns("disable-long-section-names", F, PE),
    uns("support-old-code", F, PE),
    uns("thumb-entry", V, PE),
    uns("warn-duplicate-exports", F, PE),
    uns("compat-implib", F, PE),
    uns("enable-reloc-section", F, PE),
    uns("disable-reloc-section", F, PE),
    uns("leading-underscore", F, PE),
    uns("no-leading-underscore", F, PE),
    uns("default-image-base-low", F, PE),
    uns("default-image-base-high", F, PE),
    uns("pdb", V, PE),
    uns("delayload", V, PE),
    uns("Xlink", V, PE),
    uns("guard-cf", F, PE),
    uns("no-guard-cf", F, PE),
    uns("guard-longjmp", F, PE),
    uns("no-guard-longjmp", F, PE),
    uns("dependent-load-flag", V, PE),
    uns("appcontainer", F, PE),
    uns("functionpadmin", OV, PE),
    uns("force-exe-suffix", F, PE),
    ign("full-shutdown", F),
];
