...
pub(crate) enum Action {
    ...
    Relax(bool),
    RelaxGp(bool),
    /// `--merge-exidx-entries` / `--no-merge-exidx-entries`.
    MergeExidx(bool),
    ImageBase,
    SectionStart,
    ...
    PackageMetadata,
    SymbolOrderingFile,
    WarnSymbolOrdering(bool),
    CallGraphProfileSort,
    NoCallGraphProfileSort,
    CallGraphOrderingFile,
    PrintSymbolOrder,
    GdbIndex(bool),
    DebugNames(bool),
    S390Pgste,
...
pub static GNU_OPTIONS: &[OptionDef] = &[
    ...
    imp(
        ...
        A::RelaxGp(true),
        "",
        "RISC-V: relax accesses near __global_pointer$ to gp-relative",
    ),
    imp(
        "no-relax-gp",
        F,
        A::RelaxGp(false),
        "",
        "RISC-V: no gp-relative relaxation (default)",
    ),
    imp(
        "image-base",
        V,
    ...
    imp(
        ...
        F,
        A::FixCortexA53Erratum835769,
        "",
        "Work around AArch64 Cortex-A53 erratum 835769",
    ),
    imp(
        "z",
        V,
    ...
    imp(
        ...
        V,
        A::SymbolOrderingFile,
        "FILE",
        "Order sections by the symbols listed in FILE",
    ),
    imp(
        "call-graph-ordering-file",
        V,
        A::CallGraphOrderingFile,
        "FILE",
        "Order sections by the call graph in FILE",
    ),
    imp(
        "call-graph-profile-sort",
        OV,
        A::CallGraphProfileSort,
        "ALGO",
        "Order sections by call graph profile: none, hfsort or cdsort",
    ),
    imp(
        "no-call-graph-profile-sort",
        F,
        A::NoCallGraphProfileSort,
        "",
        "Do not order sections by call graph profile (default)",
    ),
    imp(
        "print-symbol-order",
        EV,
        A::PrintSymbolOrder,
        "FILE",
        "Write the symbol order chosen by call graph sorting to FILE",
    ),
    imp(
        "gdb-index",
        F,
    ...
    imp(
        ...
        A::DebugNames(true),
        "",
        "Write a merged .debug_names section",
    ),
    imp(
        "no-debug-names",
        F,
        A::DebugNames(false),
        "",
        "Do not write a merged .debug_names section (default)",
    ),
    imp(
        "separate-debug-file",
        OV,
        A::SeparateDebugFile(true),
        "FILE",
        "Write debug sections to FILE (default: OUTPUT.dbg)",
    ),
    imp(
        "no-separate-debug-file",
        F,
        A::SeparateDebugFile(false),
        "",
        "Keep debug sections in the output (default)",
    ),
    ...
    imp(
        ...
        A::MergeExidx(true),
        "",
        "Arm: merge .ARM.exidx entries that repeat the one before (default)",
    ),
    imp(
        ...
        A::MergeExidx(false),
        "",
        "Arm: keep every .ARM.exidx entry",
    ),
    ign("target1-abs", F),
    ...
    imp(
        ...
        F,
        A::WarnSymbolOrdering(true),
        "",
        "Warn about symbols of --symbol-ordering-file that cannot be ordered (default)",
    ),
    imp(
        "no-warn-symbol-ordering",
        F,
        A::WarnSymbolOrdering(false),
        "",
        "Do not warn about symbols of --symbol-ordering-file that cannot be ordered",
    ),
...
pub static Z_KEYWORDS: &[ZKeyword] = &[
    ...
    zimp(
        ...
        ZF,
        Z::ForceBti,
        "AArch64: BTI landing pads in the PLT, warn on inputs without BTI",
    ),
    zimp(
        "pac-plt",
        ZF,
        Z::PacPlt,
        "AArch64: authenticate addresses in PLT entries",
    ),
