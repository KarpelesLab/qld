...
pub fn classify(r_type: u32, context: ClassifyContext) -> Result<Class, ClassifyError> {
    ...
    Ok(match r_type {
        ...
        R_RISCV_ADD8 => class(K::Abs, F::Add8),
        R_RISCV_ADD16 => class(K::Abs, F::Add16),
        R_RISCV_ADD32 => class(K::Abs, F::Add32),
        R_RISCV_ADD64 => class(K::Abs, F::Add64),
        R_RISCV_SUB6 => class(K::Abs, F::Sub6),
        R_RISCV_SUB8 => class(K::Abs, F::Sub8),
        R_RISCV_SUB16 => class(K::Abs, F::Sub16),
        R_RISCV_SUB32 => class(K::Abs, F::Sub32),
        R_RISCV_SUB64 => class(K::Abs, F::Sub64),
